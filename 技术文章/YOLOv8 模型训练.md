...
进入虚拟机根目录：
yolo detect train data=d:/data/yoloTrain/道路表面缺陷检测/data.yaml model=d:/data/yoloTrain/yolov8s.pt epochs=100 imgsz=640 device=0 close_mosaic=0
...
yolo export model=d:/data/yoloTrain/煤矿安全帽检测/runs/detect/train/weights/best.pt format=onnx simplify=True
