...
进入虚拟机根目录：
yolo detect train data=d:/data/yoloTrain/骑电动不佩戴头盔/data.yaml model=d:/data/yoloTrain/yolov8s.pt epochs=100 imgsz=640 device=0 close_mosaic=0
...
yolo export model=d:/data/yoloTrain/骑电动不佩戴头盔/runs/detect/train/weights/best.pt format=onnx simplify=True
