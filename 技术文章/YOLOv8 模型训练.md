...
进入虚拟机根目录：
yolo detect train data=d:/data/yoloTrain/belt/data.yaml model=d:/data/yoloTrain/yolov8s.pt epochs=150 imgsz=640 device=0 close_mosaic=0
...
yolo export model=d:/data/yoloTrain/belt/runs/detect/train/weights/best.pt format=onnx simplify=True
