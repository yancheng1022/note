...
近年来，随着人工智能技术在计算机视觉领域的快速发展，目标检测技术已广泛应用于安防监控、自动驾驶和工业质检等多个场景。然而，在公共安全领域，诸如“钓鱼”或“隔空取物”等高隐蔽性、高危害性的违法行为，因其作案动作小、时间短且往往处于监控画面的边缘区域，给传统检测方法带来了巨大挑战。现有通用目标检测模型在面对此类小目标、弱特征行为时，常出现漏检与误检问题，难以满足实际预警需求。因此，研究基于YOLO（You Only Look Once）系列算法的针对性优化方案，实现对“钓鱼”行为的实时、精准检测，对提升公共区域安全防范的智能化水平具有重要的理论意义与应用价值。
...
![image.png](https://yancey-note-img.oss-cn-beijing.aliyuncs.com/20251226224938.png)
