...
无人机视角下的行人检测是计算机视觉与智能感知领域的重要研究方向。随着无人机技术的快速普及，其在城市管理、应急救援、公共安全及物流配送等场景中的应用日益广泛，这使得从空中俯视角度对行人进行实时、准确的检测成为关键需求。然而，无人机视角下的行人检测面临诸多独特挑战：图像中的目标通常尺度较小且分布密集，背景复杂多变，同时无人机飞行过程中易产生运动模糊、视角畸变及光照剧烈变化等问题，这导致传统地面视角的检测方法性能显著下降。因此，研究基于YOLO（You Only Look Once）系列等高效检测算法在无人机视角下的适应性优化，对于提升低空智能感知能力、实现动态场景理解具有重要的理论价值与应用意义。
## 📌 2、数据集概览
