...
火灾烟雾检测是公共安全与灾害预警领域的关键课题。火灾常以烟雾为早期征兆，其蔓延迅速、破坏力强，对生命财产构成严重威胁。传统监控依赖人工值守，效率低且易疏漏。随着计算机视觉技术的发展，基于YOLO等深度学习模型的目标检测技术，能够实时自动识别监控视频中的烟雾与火焰，实现毫秒级预警。这不仅能提升安防系统的智能化水平，为应急响应争取宝贵时间，更可广泛应用于森林防火、智慧城市、工业安全等场景，有效防范灾难扩大，是构建主动式安全防护体系的重要技术支撑。
## 📌 2、数据集概览
...
![image.png](https://yancey-note-img.oss-cn-beijing.aliyuncs.com/20251221184440.png)
