...
![image.png](https://yancey-note-img.oss-cn-beijing.aliyuncs.com/20251228230432.png)
...
```yaml
train: E:/data/yoloTrain/person/images/train
val: E:/data/yoloTrain/person/images/val
nc: 1
names: ['person']
```
