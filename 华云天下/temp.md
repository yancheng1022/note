...
随着移动通信和智能终端的普及，手机已成为人们日常生活中不可或缺的工具。在此背景下，准确识别用户使用手机时的具体行为——尤其是区分“手持通话”与“手持玩手机”（如浏览、打字等）——对于提升用户体验、优化系统功耗管理、开发防沉迷应用以及进行人机交互研究具有重要的现实意义。
## 📌 2、数据集概览
...
![image.png](https://i-blog.csdnimg.cn/img_convert/988f1b649c23d9a0ca5c175faa9f9a5f.png)
