...
python to_kmodel.py --target k230 --model E:\temp\8\yolo-seg.onnx --dataset E:\data\yoloTrain\数字识别数据集\train\images --input_width 640 --input_height 640 --ptq_option 0
