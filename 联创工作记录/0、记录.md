...
INSERT INTO  `notice_alarm_setting` (`module_name`, `type`, `notice_type`, `notice_url`, `notice_phones`, `notice_state`, `notice_end_state`, `notice_middle_state`, `scene_type`, `scene_name`, `notice_rate`, `notice_unit`, `notice_last_time`) VALUES ('AQ', '1', '0', 'https://yun.tim.qq.com/v5/tlssmssvr/sendsms', '13672161182', '1', '0', '0', '16', '传感器超限报警', '360', '分钟', '2021-11-12 15:36:23');

INSERT INTO `godboot_csms`.`notice_alarm_setting` (`module_name`, `type`, `notice_type`, `notice_url`, `notice_phones`, `notice_state`, `notice_end_state`, `notice_middle_state`, `scene_type`, `scene_name`, `notice_rate`, `notice_unit`, `notice_last_time`) VALUES ('AQ', '1', '0', 'https://yun.tim.qq.com/v5/tlssmssvr/sendsms', '19992817583,13834572598,18634905947', '1', '0', '0', '12', '传感器超限预警', '30', '分钟', '1900-01-01 00:00:00');
