...
INSERT INTO `godboot_csms`.`notice_alarm_setting` (`module_name`, `type`, `notice_type`, `notice_url`, `notice_phones`, `notice_state`, `notice_end_state`, `notice_middle_state`, `scene_type`, `scene_name`, `notice_rate`, `notice_unit`, `notice_last_time`) VALUES ('AQ', '1', '0', 'https://yun.tim.qq.com/v5/tlssmssvr/sendsms', '13672161182', '1', '0', '0', '16', '传感器超限预警', '30', '分钟', '1900-01-01 00:00:00');

INSERT INTO `godboot_csms`.`notice_alarm_setting` (`module_name`, `type`, `notice_type`, `notice_url`, `notice_phones`, `notice_state`, `notice_end_state`, `notice_middle_state`, `scene_type`, `scene_name`, `notice_rate`, `notice_unit`, `notice_last_time`) VALUES ('AQ', '2', '0', 'https://oapi.dingtalk.com/robot/send?access_token=c3b3ab520c1f67b9d11bd9aa343a4e09f51b22bd0150788175c31978bfacd0b3', '13672161182', '1', '1', '1', '16', '传感器超限预警', '30', '分钟', '1900-01-01 00:00:00');
