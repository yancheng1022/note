...
| 索引  | 文件类型                        | 入库               | 备份情况                                                                                      |
| :-- | :-------------------------- | :--------------- | ----------------------------------------------------------------------------------------- |
| 1   | AQFZ（安全分站）                  | gas_station_info | 【通用】upload/sj_temp<br>【省局】上报成功 -> 备份到upload/backup下<br>上报失败 -> 备份到upload/sj_temp/ftp_err下 |
| 2   | AQMC（模拟量传感器） 和 AQKC（开关量传感器） | gas_base_info    | 【通用】upload/sj_temp                                                                        |
