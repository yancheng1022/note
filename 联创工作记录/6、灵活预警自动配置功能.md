...
| 序号  | 通知类型         | 类型编码 | 位置                                  | 完成情况 |
| :-- | :----------- | :--- | ----------------------------------- | ---- |
| 1   | 基础信息文件每天上传一次 | 101  | DataChecklistTask.baseInfoFileCheck | 完成   |
...
-- 核查单通知 - 基础信息文件每天上传一次
INSERT INTO `notice_alarm_setting` (`module_name`, `type`, `notice_type`, `notice_url`, `notice_phones`, `notice_state`, `notice_end_state`, `notice_middle_state`, `scene_type`, `scene_name`, `notice_rate`, `notice_unit`, `notice_last_time`) VALUES ( 'AQ', '1', '0', 'https://yun.tim.qq.com/v5/tlssmssvr/sendsms', '', '1', '0', '0', '100', '基础信息文件每天上传一次', '10', '分钟', '1900-01-01 00:00:00');
