...
| :-- | :-------------------------- | :--- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- | ---------------------------------------------------------------------------------------------------------------------- |
| 1   | 报警文件中不存在实时数据                | 102  | updateParseCheckErrDetail(file.getName(), "文件：" + file.getName() + ",传感器代码:" + ssTransducerCode + "，错误的字段值：" + aqssDataModel.getSs_switching_value(),  <br>        AQSS, ErrCategory.SS_SWITCHING_VALUE_EMPTY);<br>XmlFileValidUtil.updateParseCheckErrDetail | 实时  | 【联创高科】焦煤矿煤矿【报警文件中不存在实时数据】报警开始时间：2024-05-15 10:24:31详情：发生文件：002030011AQSS20231222192419.xml,传感器代码:01D120，错误的字段值：0，请及时处理 |
