...
INSERT INTO `godboot_csms`.`sys_menu` (`p_name`, `p_id`, `menu_name`, `sort`, `href`, `menu_type`, `iconimg`, `is_show`, `permission`, `router_name`, `router_path`, `depth`, `create_by`, `create_time`, `update_by`, `update_time`, `remarks`, `del_flag`) VALUES ('运维管理', '931', '月报告管理', '1', 'operaManagement/monthlyReport/index', '1', '', '1', '', 'MonthlyReport', '/monthlyReport', '3', '1', '2024-07-08 13:25:28', '1', '2024-07-08 13:29:58', NULL, '0');
INSERT INTO `godboot_csms`.`sys_menu` (`p_name`, `p_id`, `menu_name`, `sort`, `href`, `menu_type`, `iconimg`, `is_show`, `permission`, `router_name`, `router_path`, `depth`, `create_by`, `create_time`, `update_by`, `update_time`, `remarks`, `del_flag`) VALUES ('运维管理', '931', '核查单通知', '2', 'operaManagement/checklist/index', '1', '', '1', '', 'Checklist', '/checklist', '3', '1', '2024-07-03 15:22:07', '1', '2024-07-08 13:30:24', NULL, '0');

INSERT INTO `godboot_csms`.`sys_menu` (`p_name`, `p_id`, `menu_name`, `sort`, `href`, `menu_type`, `iconimg`, `is_show`, `permission`, `router_name`, `router_path`, `depth`, `create_by`, `create_time`, `update_by`, `update_time`, `remarks`, `del_flag`) VALUES ('运维管理', '931', '短信记录', '3', 'operaManagement/smsRecord/index', '1', '', '1', '', 'SmsRecord', '/smsRecord', '3', '1', '2024-07-03 15:28:56', '1', '2024-07-03 15:30:41', NULL, '0');

INSERT INTO `godboot_csms`.`sys_menu` (`p_name`, `p_id`, `menu_name`, `sort`, `href`, `menu_type`, `iconimg`, `is_show`, `permission`, `router_name`, `router_path`, `depth`, `create_by`, `create_time`, `update_by`, `update_time`, `remarks`, `del_flag`) VALUES ('运维管理', '931', '统计分析', '4', 'operaManagement/statistic/index', '1', '', '1', '', 'OperaStatistic', '/operaStatistic', '3', '1', '2024-07-03 15:31:36', '1', '2024-07-03 15:32:56', NULL, '0');
```