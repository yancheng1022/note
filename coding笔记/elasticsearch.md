...
但如果是基于title做模糊查询，只能是逐行扫描数据，也就是全表扫描，随着数据量增加，其查询效率也会越来越低。当数据量达到数百万时，就是一场灾难。
...
![image.png|675](https://yancey-note-img.oss-cn-beijing.aliyuncs.com/202402191632460.png)
